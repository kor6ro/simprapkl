...
@section('content')
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Edit Presensi Gambar</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="card card-primary">
        <div class="card-body">
            <h4 class="card-title text-primary mb-4">Edit Presensi Gambar</h4>
            <form action="{{ route('presensi_gambar.update', $presensi_gambar->id) }}" method="post"
                    ...
                    <div class="col-xl-auto">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="gmbr_presensi_pagi" id="gmbr_presensi_pagi"
                                value="{{ old('gmbr_presensi_pagi') ? old('gmbr_presensi_pagi') : $presensi_gambar->gmbr_presensi_pagi }}">
                    ...
                    <div class="col-xl-auto">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="gmbr_presensi_sore" id="gmbr_presensi_sore"
                                value="{{ old('gmbr_presensi_sore') ? old('gmbr_presensi_sore') : $presensi_gambar->gmbr_presensi_sore }}">
