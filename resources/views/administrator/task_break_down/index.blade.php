...
@section('content')
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Task Break Down</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="row mb-3">
        <div class="col-auto">
            <a href="{{ route('task_break_down.create') }}" class="btn btn-success">
                <i class="fa fa-plus me-1"></i> Tambah </a>
        </div>
    </div>
    <div class="card">
        <div class="card-body">
    ...
    <div class="d-none">
        <form id="form-destroy" action="{{ route('task_break_down.store') }}" method="post">
            @csrf
            @method('DELETE')
        </form>
    </div>
