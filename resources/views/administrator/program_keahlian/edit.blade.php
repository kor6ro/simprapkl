...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Edit Program Keahlian</h4>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.program-keahlian.update', $programKeahlian->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="nama" id="nama"
                                value="{{ old('nama', $programKeahlian->nama) }}" required>
                            @error('nama')
