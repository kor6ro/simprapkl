...
@section('content')
    ...
    @if (isRole('Siswa'))
        <div class="row">
            <div class="col-12">
                <a href="{{ route('presensi.create') }}" class="btn btn-success mb-3">
                    <i class="fa fa-fingerprint me-1"></i> Presensi Sekarang
                </a>
            </div>
        </div>
    @endif
                        ...
                        <div class="d-flex">
                            ...
                            <div class="flex-shrink-0 align-self-center">
                                <div class="mini-stat-icon avatar-sm rounded-circle bg-primary">
                                    <span class="avatar-title"><i class="fa fa-users font-size-24"></i></span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="flex-shrink-0 align-self-center">
                                <div class="avatar-sm rounded-circle bg-success mini-stat-icon">
                                    <span class="avatar-title rounded-circle bg-success"><i
                                            class="fa fa-calendar-check font-size-24"></i></span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="flex-shrink-0 align-self-center">
                                <div class="avatar-sm rounded-circle bg-warning mini-stat-icon">
                                    <span class="avatar-title rounded-circle bg-warning"><i
                                            class="fa fa-sun font-size-24"></i></span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="flex-shrink-0 align-self-center">
                                <div class="avatar-sm rounded-circle bg-info mini-stat-icon">
                                    <span class="avatar-title rounded-circle bg-info"><i
                                            class="fa fa-moon font-size-24"></i></span>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    @forelse($recentPresensi as $presensi)
                                        <tr>
                                            ...
                                            <td>{{ $presensi->PresensiJenis->nama ?? 'N/A' }}</td>
                                            <td>
                                                <span
                                                    class="badge badge-{{ $presensi->sesi == 'pagi' ? 'warning' : 'info' }}">
