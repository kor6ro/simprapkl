...
@section('content')
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Presensi Gambar</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th scope="col">#</th>
                        <th scope="col">Gmbr Presensi Pagi</th>
                        <th scope="col">Gmbr Presensi Sore</th>
                        <th scope="col">Presensi Id</th>
    ...
    <div class="d-none">
        <form id="form-destroy" action="{{ route('presensi_gambar.store') }}" method="post">
            @csrf
            @method('DELETE')
        </form>
    </div>
    ...
    <script>
        $('table').DataTable({
            ...
            columns: [{
                ...
                {
                    data: 'gmbr_presensi_pagi',
                    searchable: true,
                    orderable: true,
                    visible: true,
                },
                {
                    data: 'gmbr_presensi_sore',
                    searchable: true,
                    orderable: true,
                    visible: true,
                },
