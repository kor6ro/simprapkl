                        ...
                        <div>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="1" id="validasi"
                                    name="validasi"
                                    {{ old('validasi') == 1 ? 'checked' : ($profile->validasi == 1 ? 'checked' : '') }}>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" name="sekolah_id" id="sekolah_id">
                                ...
                                @foreach ($sekolah as $val)
                                    <option value="{{ $val->id }}"
                                        {{ old('sekolah_id') == $val->id ? 'selected' : ($profile->sekolah_id == $val->id ? 'selected' : '') }}>
                                        {{ $val->nama }}</option>
                                @endforeach
                            </select>
                            @error('sekolah_id')
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" name="group_id" id="group_id">
                                ...
                                @foreach ($group as $val)
                                    <option value="{{ $val->id }}"
                                        {{ old('group_id') == $val->id ? 'selected' : ($profile->group_id == $val->id ? 'selected' : '') }}>
                                        {{ $val->nama }}</option>
                                @endforeach
                            </select>
                            @error('group_id')
