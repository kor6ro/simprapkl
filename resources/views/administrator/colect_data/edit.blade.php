...
@section('content')
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Edit Colect Data</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="card card-primary">
        <div class="card-body">
            <h4 class="card-title text-primary mb-4">Edit Colect Data</h4>
                ...
                <div class="row">
                    <div class="col-xl-auto">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="date" name="tanggal" id="tanggal"
                                value="{{ old('tanggal') ? old('tanggal') : $colect_data->tanggal }}">
                            @error('tanggal')
                    ...
                    <div class="col-xl-auto">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nama_cus" id="nama_cus"
                                value="{{ old('nama_cus') ? old('nama_cus') : $colect_data->nama_cus }}">
                            @error('nama_cus')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-xl-auto">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="no_telp" id="no_telp"
                                value="{{ old('no_telp') ? old('no_telp') : $colect_data->no_telp }}">
                            @error('no_telp')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-xl-auto">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="alamat_cus" id="alamat_cus" rows="3">{{ old('alamat_cus') ? old('alamat_cus') : $colect_data->alamat_cus }}</textarea>
                            @error('alamat_cus')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-xl-auto">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="provider_sekarang" id="provider_sekarang"
                                value="{{ old('provider_sekarang') ? old('provider_sekarang') : $colect_data->provider_sekarang }}">
                    ...
                    <div class="col-xl-auto">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="kelebihan" id="kelebihan" rows="3">{{ old('kelebihan') ? old('kelebihan') : $colect_data->kelebihan }}</textarea>
                            @error('kelebihan')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-xl-auto">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="kekurangan" id="kekurangan" rows="3">{{ old('kekurangan') ? old('kekurangan') : $colect_data->kekurangan }}</textarea>
                            @error('kekurangan')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-xl-auto">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="serlok" id="serlok"
                                value="{{ old('serlok') ? old('serlok') : $colect_data->serlok }}">
                            @error('serlok')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-xl-auto">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="gambar_foto" id="gambar_foto"
                                value="{{ old('gambar_foto') ? old('gambar_foto') : $colect_data->gambar_foto }}">
                            @error('gambar_foto')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-xl-auto">
                        <div class="form-group">
                            ...
                            <select class="form-select" name="user_id" id="user_id">
                                ...
                                @foreach ($user as $val)
                                    <option value="{{ $val->id }}"
                                        {{ old('user_id') == $val->id ? 'selected' : ($colect_data->user_id == $val->id ? 'selected' : '') }}>
                                        {{ $val->name }}</option>
                                @endforeach
                            </select>
                            @error('user_id')
