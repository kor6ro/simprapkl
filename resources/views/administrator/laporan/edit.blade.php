...
@section('content')
    ...
    <div class="card card-primary">
        <div class="card-body">
            <h4 class="card-title text-primary mb-4">Edit Laporan</h4>
                    ...
                    <div class="col-xl-auto">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="jenis_kegiatan" id="jenis_kegiatan"
                                value="{{ old('jenis_kegiatan') ? old('jenis_kegiatan') : $laporan->jenis_kegiatan }}">
                    ...
                    <div class="col-xl-auto">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="lokasi" id="lokasi"
                                value="{{ old('lokasi') ? old('lokasi') : $laporan->lokasi }}">
                            @error('lokasi')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-xl-auto">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="homepass" id="homepass"
                                value="{{ old('homepass') ? old('homepass') : $laporan->homepass }}">
                            @error('homepass')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-xl-auto">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="jml_orang_ditemui" id="jml_orang_ditemui"
                                value="{{ old('jml_orang_ditemui') ? old('jml_orang_ditemui') : $laporan->jml_orang_ditemui }}">
                    ...
                    <div class="col-xl-auto">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="detail_pekerjaan" id="detail_pekerjaan"
                                value="{{ old('detail_pekerjaan') ? old('detail_pekerjaan') : $laporan->detail_pekerjaan }}">
                    ...
                    <div class="col-xl-auto">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="hasil_capaian" id="hasil_capaian"
                                value="{{ old('hasil_capaian') ? old('hasil_capaian') : $laporan->hasil_capaian }}">
                            @error('hasil_capaian')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-xl-auto">
                        <div class="form-group">
                            ...
                            <select class="form-select" name="user_id" id="user_id">
                                ...
                                @foreach ($user as $val)
                                    <option value="{{ $val->id }}"
                                        {{ old('user_id') == $val->id ? 'selected' : ($laporan->user_id == $val->id ? 'selected' : '') }}>
                                        {{ $val->name }}</option>
                                @endforeach
                            </select>
                            @error('user_id')
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" name="jenis_laporan_id" id="jenis_laporan_id">
                                ...
                                @foreach ($jenis_laporan as $val)
                                    <option value="{{ $val->id }}"
                                        {{ old('jenis_laporan_id') == $val->id ? 'selected' : ($laporan->jenis_laporan_id == $val->id ? 'selected' : '') }}>
                                        {{ $val->nama }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" name="laporan_gambar_id" id="laporan_gambar_id">
                                ...
                                @foreach ($laporan_gambar as $val)
                                    <option value="{{ $val->id }}"
                                        {{ old('laporan_gambar_id') == $val->id ? 'selected' : ($laporan->laporan_gambar_id == $val->id ? 'selected' : '') }}>
                                        {{ $val->gambar }}</option>
                                @endforeach
                            </select>
