...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Edit Jenis Kegiatan</h4>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.jenis_kegiatan.update', $jenisKegiatan->id) }}" method="POST"
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="nama_kegiatan" id="nama_kegiatan"
                                value="{{ old('nama_kegiatan', $jenisKegiatan->nama_kegiatan) }}" required>
                            @error('nama_kegiatan')
