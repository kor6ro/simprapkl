...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Jenis Laporan</h4>
    ...
    <div class="row mb-3">
        <div class="col-auto">
            <a href="{{ route('jenis_laporan.create') }}" class="btn btn-success">
    ...
    <div class="d-none">
        <form id="form-destroy" action="{{ route('jenis_laporan.store') }}" method="post">
            @csrf
            @method('DELETE')
        </form>
    </div>
...
@section('js')
    <script>
        $('table').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: baseUrl('/jenis_laporan/fetch'),
                headers: {
            ...
            createdRow: function(row, data) {
                $(".action-edit", row).click(function(e) {
                    const url = baseUrl('/jenis_laporan/' + data.id + '/edit');
