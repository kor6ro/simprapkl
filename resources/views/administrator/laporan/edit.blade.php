    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Edit Laporan Kegiatan</h4>
            ...
            <form action="{{ route('admin.laporan.update', $laporan->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <select class="form-select @error('jenis_kegiatan_id') is-invalid @enderror"
                                ...
                                @foreach ($jenis_kegiatan as $kegiatan)
                                    <option value="{{ $kegiatan->id }}"
                                        {{ old('jenis_kegiatan_id', $laporan->jenis_kegiatan_id) == $kegiatan->id ? 'selected' : '' }}>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('deskripsi_kegiatan') is-invalid @enderror" name="deskripsi_kegiatan"
                        id="deskripsi_kegiatan" rows="4" required>{{ old('deskripsi_kegiatan', $laporan->deskripsi_kegiatan) }}</textarea>
                ...
                <div class="mb-3">
                    <label for="bukti_foto" class="form-label">Ganti Bukti Foto (Opsional, maks. 2MB)</label>
